    ...
    let listings = result.map((item, index) => {
        return (
             <div class="card mb-4 col-3 mr-5 ml-5 d-inline-flex align-items-center" style={{display:'inline-block',maxHeight:'600px'}}>
              <div style={{height:'400px'}} class="d-flex"><img class="card-img-top" src={item.image_url} alt="Card image cap" style={{objectFit:'contain', margin:'auto 0',alignSelf:'center',maxHeight:'300px'}}/></div>
