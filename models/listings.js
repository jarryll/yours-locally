module.exports = (dbPoolInstance) => {
    ...
    const getShopListings = (shopID, callback) => {
        let query = `SELECT listings.listing_name, listings.image_url, listings.listing_details FROM shops INNER JOIN listings ON shops.id = listings.shop_id WHERE shops.id = ${shopID}`;
